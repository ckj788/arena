...
- New products publish immediately as `unreviewed`; no mandatory manual queue. Their external links use `ugc nofollow noopener noreferrer` until approved. This is link labeling, **not** a malware scan or safety certification.
